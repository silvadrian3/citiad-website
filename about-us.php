...
<body id="page-top" class="index">
        ...
        <div class="container">
            <div class="row" style="padding-top:50px">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">About the Company</h2>
                    ...
                    <ul class="timeline">
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <!--<h4>January 2013</h4>-->
                                    <h4 class="subheading">The Growth of the Company</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">The company continued to grow and started to handle significantly bigger projects which led to the addition of the event management as part to its service offerings.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-heading">
                                    <!--<h4>July 2014</h4>-->
                                    <h4 class="subheading">Who we are now</h4>
                                </div>
                                
                                <div class="timeline-body">
                                    <p class="text-muted">Citiad Delivers good satisfying events, high class promotional giveaways, and high quality printing services for professional associations, corporations, small to large scale companies and government agencies.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
    ...
    <section id="mission-vision" class="bg-light-gray" style="margin-top:50px; padding-bottom:50px">
        <div class="container">
            <!--
            <div class="row">
                <div class="col-lg-12 text-center">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="mission-vision">
                        ...
                        <p class="text-muted large text-left">We aim to provide our clients and their guest a platform that aptly combines the imagination prowess of a creative minds, and the latest in advertising concept.</p>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="mission-vision">
                        <h1 class="text-left">Our Vision</h1>
                        <p class="text-muted large text-left">Big dreams for a teenage company. We want to build a sustainable and profitable business with the people who are brilliant at what they do. Producing, sourcing and selling beautiful, inspiring and high quality products and services.</p>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="mission-vision">
                        <h1 class="text-left">Our Values</h1>
                        <p class="text-muted large text-left">We value Integrity, Consistency, Quality and Innovation. We are building a sustainable business. We inspire people to do amazing stuff.Honesty underlines our dealings with customers and business partners. At work, Team members can grow and be happy.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="values text-muted">&#8220;CAN DO&#8221; is how we approach in everything we do.</h3>
                </div>
            </div>
        </div>
    </section>
