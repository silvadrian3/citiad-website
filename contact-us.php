...
<body id="page-top" class="index">
        ...
        <div class="container">
            <div class="row" style="padding-top:75px">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Please get in touch!</h2>
            ...
            <div class="row" style="padding: 15px 0 30px 0;">
                ...
                <div class="col-md-8">
                    <iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3860.3321584796463!2d121.11985246486893!3d14.637076939779288!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b9abc4ccc30b%3A0xc86f89c13ba05ec1!2sBueno+Tierra+Building!5e0!3m2!1sen!2sph!4v1501673974337" allowfullscreen></iframe>
                </div>
                <div class="col-md-4">
                    <p class="text-muted">Unit C3 Bueno Tierra Bldg., 4580 Lilac St., SSS Village <br>Concepcion Dos, Marikina City</p>
                    <p class="text-muted">8879 2607<br/>8668 6220<br/>+63 939 104 6227<br/>+63 956 605 3474</p>
                    <p class="text-muted"><a href="mailto:sales@citiad.co">sales@citiad.co</a><br/><a href="mailto:sales@citiad.co">info@citiad.co</a></p>
                    <p class="text-muted">Monday to Friday, 9<small>AM</small> to 6<small>PM</small><br>Saturday, 9<small>AM</small> to 12<small>NN</small></p>
                    
                    <!--
                    <p class="text-muted">Instagram: <a href="https://www.instagram.com/">@instagram</a></p>
                    <p class="text-muted">Twitter: <a href="https://www.twitter.com/citiadpromo">/citiadpromo</a></p>
                    -->
                    <p class="text-muted">
                        <!--Facebook: <a href="https://www.facebook.com/citiadpromo"> /citiadpromo</a>-->
                        <br/>
                        <iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fcitiadpromo%2F&width=122&layout=button&action=like&size=large&show_faces=true&share=true&height=65&appId" width="122" height="65" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    ...
    <section id="team" class="bg-light-gray" style="margin-top:50px; padding-bottom:50px">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    
                    <h2 class="section-heading">Interested in our services?</h2>
                    <h3 class="section-subheading text-muted">Contact us by submitting the form below and we'll get back to you as soon as possible!</h3>
                    ...
                    <form role="form" method="post">
                        <div class="row">
                            <div class="col-lg-6 col-lg-offset-3">
                                ...
                                <div class="form-group col-lg-12">
                                    <button type="submit" name="submit" onclick="return submit_message()" class="btn warning pull-right">Submit</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
if(isset($_POST['submit'])){
    ...
    $body .= '<p>'. $firstname . ' ' . $lastname .' submitted an inquiry from <i>Contact Us</i> page. Please see below details:<br/></p>';
    ...
    $success_msg = "Thank you for submitting your inquiry. Our sales team will contact you shortly.";
